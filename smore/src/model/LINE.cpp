...
void LINE::Train(int sample_times, int negative_samples, double alpha, double beta, int workers, bool if_sbert){
        ...
        for (int worker=0; worker<workers; ++worker)
        {
            ...
            {            
                ...
                if (!if_sbert)
                    ...
                    pnet.UpdatePair_Sbert(w_vertex, w_context, w_bert, v1, v2, dim, negative_samples, _alpha, _beta);
