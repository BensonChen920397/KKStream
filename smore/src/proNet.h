...
class proNet {
    ...
    public:
        ...
        double SbertSimilarity(vector<double>&, vector<double>&);
        ...
        void Opt_SigmoidSGD_SBERT(vector<double>&, vector<double>&, vector<double>&, vector<double>&, double, int, double, double, vector<double>&, vector<double>&);
        ...
        void UpdatePair_Sbert(vector< vector<double> >&, vector< vector<double> >&, vector< vector<double> >&, long, long, int, int, double, double);
